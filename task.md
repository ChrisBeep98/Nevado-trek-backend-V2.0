...
145. [ ] Initialize Vite Project (`admin-dashboard`) with Tailwind & Framer Motion
146. [ ] Setup Project Structure (Contexts, Hooks, Components)
147. [ ] Implement Auth Context (Login with Key) & API Client
148. [ ] Build Layout Shell (Collapsible Sidebar, Glassmorphism)

### Phase 8: Admin Frontend - Core Features
149. [ ] Build Reusable UI Components (Modal, Tabs, Cards)
150. [ ] Implement Tours Management (Grid, Create/Edit Modal with new fields)
151. [ ] Implement Departures Calendar (FullCalendar integration)
152. [ ] Implement Departure Modal (Tabs: Overview, Bookings, Actions)
153. [ ] Implement Bookings Management (List, Create Wizard, Detail Modal)
154. [ ] Implement Dashboard Stats & Polish (Animations, Toasts)