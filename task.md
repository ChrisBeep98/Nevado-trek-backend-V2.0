...
11. [ ] Initialize Vite Project (`admin-dashboard`)
12. [ ] Setup Routing & Auth Context
13. [ ] Create API Client (Axios with Interceptor)
14. [ ] Develop Admin Views (Calendar, Bookings, Tours)