...
async function createNevadoDelTolimaTour() {
  console.log('Creating production tour: Nevado del Tolima...');
  ...
  const tourData = {
    ...
    departure: "Salento",
    price: {
      amount: 1000000, // Base price, using the group price as reference
      currency: "COP"
    },
    pricingTiers: [
      {
        pax: 1,
        pricePerPerson: 2780000
      },
      {
        pax: 2,
        pricePerPerson: 1660000
      },
      {
        pax: 3,
      ...
      days: [
        {
          day: 1,
          title: { 
            es: "Día 1: Inicio del viaje", 
            en: "Day 1: Journey Start" 
          },
          activities: [
        ...
        },
        {
          day: 2,
          title: { 
            es: "Día 2: Páramo y Laguna del Encanto", 
            en: "Day 2: Páramo and Laguna del Encanto" 
          },
          activities: [
        ...
        },
        {
          day: 3,
          title: { 
            es: "Día 3: Intento de cumbre", 
            en: "Day 3: Summit Attempt" 
          },
          activities: [
        ...
        },
        {
          day: 4,
          title: { 
            es: "Día 4: Descenso final", 
            en: "Day 4: Final Descent" 
          },
          activities: [
  ...
  try {
    console.log('Sending request to create tour...');
...
// Run the function
createNevadoDelTolimaTour()
  .then(() => console.log('\n🎉 Production tour creation process completed!'))
