...
async function updateBookingToDate(bookingId, targetDateStr) {
    ...
    try {
        const response = await axios.put(`${BASE_URL}/adminUpdateBookingDetails/${bookingId}`, {
            ...
            reason: "Requested date update to December 15th, 2025"
        }, {
            headers: {
...
// Run the update to December 15th
async function runUpdate() {
    console.log('Starting update to December 15th, 2025...\n');
    
    // Requesting Dec 15, 2025 in UTC
    const targetDate = new Date(Date.UTC(2025, 11, 15, 0, 0, 0)); // month is 0-indexed, so 11 = December
    ...
    if (result) {
        console.log('\n✅ Booking successfully updated to December 15th, 2025!');
